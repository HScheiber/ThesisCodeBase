function Minimize_Liquid_Interface(Settings)
    ...
    cmd = [Settings.gmx_loc Settings.insert_molecules ' -f ' windows2unix(Comb_Equil_Sol_File) ' -ci ' windows2unix(Ref_M) ...
    ...
    htimer = tic;
    cmd = [Settings.gmx_loc Settings.insert_molecules ' -ci ' windows2unix(Ref_X) ' -f ' windows2unix(Comb_Equil_Sol_Metal_File) ...
    ...
    FMin_Grompp = [Settings.gmx_loc Settings.grompp ' -c ' windows2unix(Comb_Equil_File) ...
