function [N_Supercell_a,N_Supercell_b,N_Supercell_c] = OptimizationLoop(Settings,varargin)
    ...
    a_vec = Settings.Geometry.Transform(1,:).*Settings.N_Supercell.*Settings.Geometry.a/10;
    b_vec = Settings.Geometry.Transform(2,:).*Settings.N_Supercell.*Settings.Geometry.b/10;
    c_vec = Settings.Geometry.Transform(3,:).*Settings.N_Supercell.*Settings.Geometry.c/10;
    ...
    Template_text_Lat = AddCartesianCoord(Settings.Coordinate_Template,...
        Settings.Geometry,1,false,Settings.MinMDP.CoordType);
    
    % Unit Cell Filename
    UnitCellFile = fullfile(Settings.WorkDir,[Settings.FileBase '_UnitCell.' Settings.MinMDP.CoordType]);
    
    % Supercell Filename
    SuperCellFile = fullfile(Settings.WorkDir,[Settings.FileBase '.' Settings.MinMDP.CoordType]);
    ...
    ConfOut_File = fullfile(Settings.WorkDir,[Settings.FileBase 'OutConf.' Settings.MinMDP.CoordType]);
