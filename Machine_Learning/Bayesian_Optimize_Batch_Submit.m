...
% Shared job settings
Shared_Settings.N_Calc = 14; % Number of chained calculations
...
switch lower(computer)
    case 'cedar'
        %% BF/TC - Crystal+Thermal properties with point charge + hogervorst-wbk mixing rule, pre-determined Li params
        ...
        for sidx = 1:length(Salts)
            ...
            for ridx = 1:length(Replicates)
                ...
                Settings_Array(idx).Fix_Li_params = true;           
        ...
        %% BF/TD - Crystal+Thermal properties with point charge + hogervorst-wbk mixing rule, pre-determined Li params
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        Shared_Settings.Max_Bayesian_Iterations = 600;
        ...
        %% BF/TG - Crystal+Thermal properties with point charge + hogervorst-wbk mixing rule, pre-determined Li params (cont TD)
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        ...
        Shared_Settings.GaussianCharge = false;
        Shared_Settings.Polarization = false;
        Shared_Settings.Initialize_From_Model = {'TD'};
        ...
        %% BF/TH - Crystal+Thermal properties with point charge + hogervorst-wbk mixing rule, pre-determined Li params (cont TE)
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        Shared_Settings.Max_Bayesian_Iterations = 200;
        ...
        Shared_Settings.GaussianCharge = false;
        Shared_Settings.Polarization = false;
        Shared_Settings.Initialize_From_Model = {'TE'};
        ...
        %% BF/TJ - Crystal+Thermal properties with point charge + hogervorst-wbk mixing rule, pre-determined Li params
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        ...
        Shared_Settings.GaussianCharge = false;
        Shared_Settings.Polarization = false;
        Shared_Settings.Initialize_From_Model = {'TC'};
    ...
    case 'narval'
        ...
        %% BF/TB - Crystal+Thermal properties with point charge + hogervorst-wbk mixing rule, pre-determined Li params (cont TA)
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        Shared_Settings.Max_Bayesian_Iterations = 200;
        ...
        Shared_Settings.GaussianCharge = false;
        Shared_Settings.Polarization = false;
        Shared_Settings.Initialize_From_Model = {'TA'};
        ...
        %% BF/TE - Crystal+Thermal properties with point charge + hogervorst-wbk mixing rule, pre-determined Li params
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        Shared_Settings.Max_Bayesian_Iterations = 600;
        ...
        %% BF/TF - Crystal+Thermal properties with point charge + hogervorst-wbk mixing rule, pre-determined Li params
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        Shared_Settings.Max_Bayesian_Iterations = 600;
        ...
        Settings = Shared_Settings;
        Settings.Theory = Theory;
        S = cell(1,length(Salts));
        for sidx = 1:length(Salts)
            Settings.Salt = Salts{sidx};
            Settings.Model = 'RM1';
            [RefModel_Settings,ModelFound] = Load_Model_Params(Settings);
            if ModelFound
                S{sidx} = RefModel_Settings.S;
            else
                error('Unable to load reference model.')
            end
        end
        Scomb = Init_Scaling_Object;
        ...
        %% BF/TI - Crystal+Thermal properties with point charge + hogervorst-wbk mixing rule, pre-determined Li params
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        Shared_Settings.Max_Bayesian_Iterations = 200;
        ...
        Shared_Settings.GaussianCharge = false;
        Shared_Settings.Polarization = false;
        Shared_Settings.Initialize_From_Model = {'TF'};
        ...
        %% BF/TK - Crystal+Thermal properties with point charge + hogervorst-wbk mixing rule
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
    ...
    case 'graham'
        %% BF/QG model Crystal+Thermal properties WITH Gaussian charge + 'kong-lr' mixing rule (continuation of QE)
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        Shared_Settings.Max_Bayesian_Iterations = 200;
        ...
        Shared_Settings.Polarization = false;
        Shared_Settings.Initialize_From_Model = {'QE'};
        ...
        %% BF/QH model Crystal+Thermal properties WITH Gaussian charge + 'hogervorst-wbk' mixing rule (continuation of QF)
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        Shared_Settings.Max_Bayesian_Iterations = 200;
        ...
        Shared_Settings.GaussianCharge = true;
        Shared_Settings.Polarization = false;
        Shared_Settings.Initialize_From_Model = {'QF'};
