...
switch lower(computer)
    case 'cedar'
        %% BH/PH - Crystal+Thermal properties with point charge + 'kong' mixing rule (continuation of PF)
        ...
        %% BF/PT - Crystal+Thermal properties with point charge + hogervorst-wbk mixing rule (Continuation of PP)
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        Shared_Settings.Max_Bayesian_Iterations = 200;
        ...
        Shared_Settings.GaussianCharge = false;
        Shared_Settings.Polarization = false;
        Shared_Settings.Initialize_From_Model = {'PP'};
        ...
        %% BF/PU - Crystal+Thermal properties with point charge + hogervorst-wbk mixing rule (Continuation of PP)
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        Shared_Settings.Max_Bayesian_Iterations = 200;
    ...
    case 'narval'
        ...
        %% BF/PW - Crystal+Thermal properties with point charge + 'kong-lr' mixing rule (continuation of PR)
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        Shared_Settings.Max_Bayesian_Iterations = 200;
        ...
        Shared_Settings.GaussianCharge = false;
        Shared_Settings.Polarization = false;
        Shared_Settings.Initialize_From_Model = {'PR'};
        ...
        %% BF/PV - Crystal+Thermal properties with point charge + 'kong-sr' mixing rule (continuation of PS)
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        Shared_Settings.Max_Bayesian_Iterations = 200;
        ...
        Shared_Settings.GaussianCharge = false;
        Shared_Settings.Polarization = false;
        Shared_Settings.Initialize_From_Model = {'PS'};
    ...
    case 'graham'
        %% BF/QA model Crystal+Thermal properties WITH Gaussian charge + 'kong-lr' mixing rule
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        ...
        %% BF/QB model Crystal+Thermal properties WITH Gaussian charge + 'hogervorst-wbk' mixing rule
        Shared_Settings.Initial_N_Multiplier = 40; % Multiply the number of input dimensions by this number to obtain the number of initial random points
        Shared_Settings.Acquisition_Function = 'expected-improvement-plus';
        Shared_Settings.ExplorationRatio = 2;
        Shared_Settings.Max_Bayesian_Iterations = 800;
