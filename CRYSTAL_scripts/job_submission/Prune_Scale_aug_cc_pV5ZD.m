function [Li,Na,F,Cl,Br] = Prune_Scale_aug_cc_pV5ZD(home,current_crystal_type,BSSE_id,Initialize_As_Ions)

load([home filesep 'basis_sets' filesep 'aug_cc_pV5ZD_CRYSTAL17.mat']) %#ok<LOAD>
