function [Li,Na,F,Cl,Br,I] = Prune_Scale_Basis(Basis_Set,home,current_crystal_type,BSSE_id,Initialize_As_Ions)

load([home filesep 'basis_sets' filesep Basis_Set '_CRYSTAL17.mat']) %#ok<LOAD>
