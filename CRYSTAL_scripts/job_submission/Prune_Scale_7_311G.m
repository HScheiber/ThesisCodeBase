function [Li,Na,K,Rb,F,Cl,Br,I] = Prune_Scale_7_311G(home,current_crystal_type,Initialize_As_Ions)

load([home filesep 'basis_sets' filesep '7_311G_crystal.mat']) %#ok<LOAD>

% Modify Charges if needed
if strcmp(current_crystal_type,'Ion')
    Metal_Charge = Metal_Charge-1;
    Halide_Charge = Halide_Charge+1;
    Halide_Hybrid_Charge = Halide_Hybrid_Charge+1;
...
F = strrep(F,'##CHG##',num2str(Halide_Hybrid_Charge,'%4.1f'));
Cl = strrep(Cl,'##CHG##',num2str(Halide_Hybrid_Charge,'%4.1f'));
