function [Li,Na,F,Cl,Br] = Prune_Scale_aug_cc_pV5Z(home,current_crystal_type,BSSE_id,Initialize_As_Ions)

load([home filesep 'basis_sets' filesep 'aug_cc_pV5Z_CRYSTAL17.mat']) %#ok<LOAD>
