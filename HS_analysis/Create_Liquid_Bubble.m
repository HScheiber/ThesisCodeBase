...
cmd = [Settings.gmx_loc Settings.insert_molecules ' -ci ' windows2unix(Ref_M) ' -ip ' windows2unix(pos_filename)...
...
cmd = [Settings.gmx_loc Settings.insert_molecules ' -ci ' windows2unix(Ref_X) ' -f ' windows2unix(tmp_file) ...
