...
%
function clayff_param(Atom_label,varargin)
...
%
% H
forcefield.clayff(2).type =    {'H'}; % ho hydroxyl hydrogen
...
forcefield.clayff(3).mass =    15.999410;
if sum(strcmpi('SPC/E', water_model)) > 0 || sum(strcmpi('SPCE', water_model)) > 0
...
forcefield.clayff(4).mass =    15.999410;
forcefield.clayff(4).charge =  -0.95;
forcefield.clayff(4).radius =  3.553200;
forcefield.clayff(4).e_kcalmol = 0.155400;
%
% O
forcefield.clayff(5).type =    {'O'}; % ob bridging oxygen
forcefield.clayff(5).mass =    15.999410;
forcefield.clayff(5).charge =  -1.05000;
forcefield.clayff(5).radius =  3.553200;
forcefield.clayff(5).e_kcalmol = 0.155400;
%
% Omg
forcefield.clayff(6).type =    {'Omg'}; % ob bridging oxygen w. octahedral substitution
forcefield.clayff(6).mass =    15.999410;
...
%
% Alt
forcefield.clayff(16).type =    {'Alt'}; % at tetrahedral aluminium
...
forcefield.clayff(36).mass =    15.999410;
...
% Al
forcefield.clayff(38).type =    {'Ale'}; % ao octahedral aluminium
...
% O
forcefield.clayff(44).type =    {'Op'}; % ob bridging oxygen
forcefield.clayff(44).mass =    15.999410;
forcefield.clayff(44).charge =  -1.05000;
forcefield.clayff(44).radius =  3.553200;
forcefield.clayff(44).e_kcalmol = 0.155400;

% Osi
forcefield.clayff(45).type =    {'Osi'}; % Clayffmod single and lonely Si-O
forcefield.clayff(45).mass =    15.99941;
forcefield.clayff(45).charge =  -1.52500;
forcefield.clayff(45).radius =  3.553200;
forcefield.clayff(45).e_kcalmol = 0.155400;
% Forcefield_index=find(ismember([forcefield.clayff.type],Atom_label))';
...
forcefield.clayff(46).e_kcalmol = 9.0298E-06;

% Mn (dummy for Mno)
forcefield.clayff(47).type =    {'Mn'}; % fe
forcefield.clayff(47).mass =    54.93804;
forcefield.clayff(47).charge =  2.100; %1.5750; feo
forcefield.clayff(47).radius =  4.570910278; % Kerisit, original 5.5070;
forcefield.clayff(47).e_kcalmol = 9.0298E-06;

% Mn (dummy for Mno)
forcefield.clayff(48).type =    {'Mn4'}; % fe
forcefield.clayff(48).mass =    54.93804;
forcefield.clayff(48).charge =  2.100; %1.5750; feo
forcefield.clayff(48).radius =  4.570910278; % Kerisit, original 5.5070;
forcefield.clayff(48).e_kcalmol = 9.0298E-06;

% Mn (dummy for Mno)
forcefield.clayff(49).type =    {'Mn3'}; % fe
forcefield.clayff(49).mass =    54.93804;
forcefield.clayff(49).charge =  1.575; %1.5750; feo
forcefield.clayff(49).radius =  4.570910278; % Kerisit, original 5.5070;
forcefield.clayff(49).e_kcalmol = 9.0298E-06;

% Mn (dummy for Mno)
forcefield.clayff(50).type =    {'Mn2'}; % fe
forcefield.clayff(50).mass =    54.93804;
forcefield.clayff(50).charge =  1.3600; %1.5750; feo
forcefield.clayff(50).radius =  4.570910278; % Kerisit, original 5.5070;
forcefield.clayff(50).e_kcalmol = 9.0298E-06;

% Omn (dummy for Mno)
forcefield.clayff(51).type =    {'Omn'}; % fe
forcefield.clayff(51).mass =    15.999410;
