...
Settings.TimePerFrame = 1; % post-processing time per frame check in ps
...
Settings.Ref_Density = 16.28021241; % ion pairs / nm^3
T0 = 1075.168;
...
Settings.PreEquilibration = 0; % ps. Relax the prepared system for this amount of time at the start with ultrafast relaxation settings.
