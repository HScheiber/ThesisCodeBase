...
switch lower(computer)
    ...
    case 'graham'
        ...
        Settings_array(idx).RunEnergyAnalysis = {'Temperature' 'Pressure' 'Volume'};
        ...
        Settings_array(idx).JobID = 'Berendsen_10ps_anisotropic'; % An ID that is tacked onto the folder name of all current jobs
