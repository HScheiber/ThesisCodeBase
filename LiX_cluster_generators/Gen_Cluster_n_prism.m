...
N_Cluster = 50; % Must be an even number to ensure charge neutrality
...
Geometry = Default_Crystal(Settings);
Geometry.a = DFT.(Salt).(Structure).a;
Geometry.b = DFT.(Salt).(Structure).b;
Geometry.c = DFT.(Salt).(Structure).c;
[Metal,Halide] = Separate_Metal_Halide(Salt);

% Crystal = Default_Crystal('LiF','Rocksalt',true);
% Crystal.a = 4.30100;
% Crystal.b = 4.30100;
% Crystal.c = 4.30100;
% 
...
Frac_Coordinates = [Geometry.FC_Metal; Geometry.FC_Halide];
