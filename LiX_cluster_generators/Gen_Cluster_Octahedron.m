...
N_Cluster = 400; % Must be an even number to ensure charge neutrality
Cutoff = 50; % Angstroms, maximum search distance
x_direction = [1 0 0]; % Choose any vector to align the Octahedron along
...
Rot = {[0 1 0 deg2rad(0)] [1 0 0 deg2rad(0)]}; 
...
Octahedron_center = Cluster_Center*Transform_Matrix;
...
taxicab_distance = vecnorm([x_Major y_Major z_Major] - Octahedron_center,1,2);
...
filename = fullfile(pwd,[Salt '_' Structure '_N' num2str(N_Cluster) '_Octahedron.xyz']);
