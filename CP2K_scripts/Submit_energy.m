...
Structures = {'Rocksalt' 'Wurtzite' 'NiAs'};
% {'Rocksalt' 'Wurtzite' 'FiveFive' 'NiAs' 'AntiNiAs' 'CsCl' 'Sphalerite'};
% 'BetaBeO'
Basis_Experiment = 'Sapporo-QZP-fixed'; % 'pob-TZVP' 'Sapporo-QZP' 'Sapporo-DZP'
cnt = 0;
%% Grab input templates
if ispc
    template_loc = 'C:\Users\Hayden\Documents\Patey_Lab\ThesisCodeBase\submission\CP2K_scripts';
    ALL_Potentials_loc = 'C:\Users\Hayden\Documents\Patey_Lab\ThesisCodeBase\submission\CP2K_scripts\ALL_POTENTIALS';
else
    template_loc = '/home/scheiber/ThesisCodeBase/submission/CP2K_scripts';
    ALL_Potentials_loc = '/home/scheiber/ThesisCodeBase/submission/CP2K_scripts/ALL_POTENTIALS';
    ...
    for idx = 1:length(XC_Funcs)
        ...
        for jdx = 1:length(Salts)
            ...
            switch Basis_Experiment
                ...
                case {'Sapporo-QZP' 'Sapporo-QZP-fixed'}
            ...
            for kdx = 1:length(Structures)
                ...
                if strcmp(Salt,'LiBr') || strcmp(Salt,'LiI') || strcmp(Salt,'LiAt') || strcmp(Structure,'BetaBeO')
