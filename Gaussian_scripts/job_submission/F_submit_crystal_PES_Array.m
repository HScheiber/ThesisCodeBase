...
function F_submit_crystal_PES_Array(salt_type,crystal_type)
        ...
        for k=1:length(a)
            ...
            if strcmp(l2s,'pob-TZVP')
                ...
                newtext = strrep(newtext,'##GENBAS##',['@' home filesep ...
                    'basis_sets' filesep 'pob_TZVP.gbs' newline]);
                if strcmp('LiI',salt_type)
